        ...
        for (let i = 0; i < daysInMonth; i++) {
          ...
          if(date.banlance) {
            ...
            list.push({
              ...
              calorie_intake: parseFloat(date.calorie_intake).toFixed(0),
              exercise: parseFloat(date.exercise).toFixed(0),
              standard_intake: parseFloat(date.standard_intake).toFixed(0),
              banlance: parseFloat(date.banlance).toFixed(0),
              signin: date.signin,
              color
            })
          }
