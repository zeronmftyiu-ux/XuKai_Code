...
Page({
    ...
    list: [
      {
        ...
        desc: '记录您的运动数据',
        col: 2,
        imgurl: 'http://oss.mcloud.moveclub.cn/2025/mv/doctor/%E7%BC%96%E7%BB%84%2014%E5%A4%87%E4%BB%BD%402x.png',
        value: '',
        isechat: 0
      },
      {
        ...
        desc: '记录您的四季三餐',
        col: 2,
        imgurl: 'http://oss.mcloud.moveclub.cn/2025/mv/doctor/%E7%BC%96%E7%BB%84%2015%E5%A4%87%E4%BB%BD%402x.png',
        value: '',
        isechat: 0
      },
      {
  ...
  go(e){
    ...
    if(this.data.waiting !== '200'){ //等待授权状态
      return
    }
    if(id != 11 && !this.data.auth) {
      wx.showModal({
        title: '提示',
        content: '您还未授权华为运动健康数据，请前往数据授权中心进行授权',
        confirmText:'确定前往',
        confirmColor: '#00C7C7',
        success (res) {
          if (res.confirm) {
